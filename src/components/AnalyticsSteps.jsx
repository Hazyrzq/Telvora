      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-base md:text-lg lg:text-xl text-slate-400 max-w-2xl mx-auto animate-fade-in-up delay-300 leading-relaxed">
            Proses sederhana untuk mendapatkan insight yang powerful
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 items-stretch">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.no} className="relative flex flex-col">
                  ...
                  <div className="relative flex flex-col flex-1">
                    <div
                      className="rounded-2xl border border-[#1e2a3d] bg-[#0f1727] p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out flex flex-col h-full animate-fade-in-up hover:-translate-y-1"
                      style={{ animationDelay: `${300 + index * 100}ms` }}
                    >
                      <div className="flex flex-col flex-1 h-full">
                        {/* Step Number Badge */}
                        <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-[#182338] text-sky-300 font-semibold text-xl mb-4">
                          {step.no}
                        </div>
                        
                        {/* Icon */}
                        <div className="mb-4">
                          <div className="inline-flex p-3 rounded-xl bg-[#182338] text-slate-100 animate-float-soft">
