        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight bg-gradient-to-r from-white via-cyan-100 to-white bg-clip-text text-transparent animate-fade-in-up delay-200">
              Telvora Analytics
              <span className="block text-slate-200 text-2xl md:text-3xl lg:text-4xl font-semibold mt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-400">
              <Button
                asChild
                size="lg"
                className="bg-cyan-600 hover:bg-cyan-500 text-white font-semibold text-base px-8 py-5 h-auto rounded-xl transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 focus-visible:ring-2 focus-visible:ring-cyan-300"
              >
            ...
            <div className="relative w-full max-w-md transition-transform duration-500 ease-out hover:-translate-y-2 hover:shadow-2xl animate-float-soft">
              <div className="bg-slate-900/80 border border-slate-800 rounded-2xl shadow-lg">
                <div className="flex items-center gap-2 px-5 py-3 border-b border-slate-800">
                  ...
                  <span className="ml-3 text-xs uppercase tracking-wide text-slate-400">rekomendasi.js</span>
                </div>
                <pre className="font-mono text-sm text-slate-300 px-5 py-6 space-y-2">
