...
const TentangSistem = () => {
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <Button 
            asChild 
            variant="ghost" 
            className="mb-8 text-slate-400 hover:text-white hover:bg-slate-800/50 transition-all duration-200 animate-fade-in-up group"
          >
          ...
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 text-white animate-fade-in-up delay-200 tracking-tight">
              Telvora Analytics
              <span className="block text-slate-200 text-3xl md:text-4xl font-normal mt-2">
                Platform
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl text-slate-300 leading-relaxed mb-8 animate-fade-in-up delay-300">
      ...
      <section className="py-16 border-t border-slate-800">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed animate-fade-in-up delay-300">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <h3 className="text-xl font-semibold text-white mb-3 tracking-tight">1. Koleksi Data</h3>
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                <h3 className="text-xl font-semibold text-white mb-3 tracking-tight">2. Analisis dengan Machine Learning</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                <h3 className="text-xl font-semibold text-white mb-3 tracking-tight">3. Generasi Rekomendasi</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
                <h3 className="text-xl font-semibold text-white mb-3 tracking-tight">4. Continuous Learning</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <h3 className="text-lg font-semibold text-cyan-400 mb-2 tracking-tight">Meningkatkan Retensi Pelanggan</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                <h3 className="text-lg font-semibold text-cyan-400 mb-2 tracking-tight">Meningkatkan Konversi Penjualan</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                <h3 className="text-lg font-semibold text-cyan-400 mb-2 tracking-tight">Optimasi Operasional</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <div className="bg-[#0f1727] border border-[#1e2a3d] rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
                <h3 className="text-lg font-semibold text-cyan-400 mb-2 tracking-tight">Pengambilan Keputusan Data-Driven</h3>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                    className="flex flex-col h-full border border-[#1e2a3d] bg-[#0f1727] shadow-sm hover:shadow-xl transition-all duration-300 ease-out hover:-translate-y-1 animate-fade-in-up"
                  style={{ animationDelay: `${400 + index * 100}ms` }}
                >
                  <CardHeader>
                    <div className="inline-flex p-4 rounded-2xl bg-[#182338] text-sky-300 mb-4 animate-float-soft">
                      <Icon className="w-8 h-8" />
                    </div>
                    <CardTitle className="text-xl md:text-2xl text-white tracking-tight">
                      {feature.title}
                    </CardTitle>
                  </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto items-stretch">
            {capabilities.map((capability, index) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div className="inline-flex p-3 rounded-xl bg-[#182338] text-sky-300 mb-4 animate-float-soft">
                      <Icon className="w-6 h-6" />
                    </div>
                    <CardTitle className="text-lg md:text-xl text-white">{capability.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="border border-[#1e2a3d] bg-[#0f1727] shadow-sm hover:shadow-xl transition-all duration-300 ease-out max-w-4xl mx-auto animate-fade-in-up">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl md:text-4xl font-extrabold text-white mb-4 tracking-tight">
                Siap Memulai?
              </CardTitle>
              <CardDescription className="text-base md:text-lg lg:text-xl text-slate-400">
